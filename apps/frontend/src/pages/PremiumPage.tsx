        ...
        <div className="mx-auto max-w-[1600px] flex flex-col">
          <div className="mb-6 flex items-center justify-between rounded-2xl border border-border/60 bg-card px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-base font-semibold sm:text-lg">Premium</h1>
              </div>
            </div>
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              Upgrade to premium and get access to all exclusive features,
              tools, and resources to accelerate your coding journey
            </p>
          </div>
